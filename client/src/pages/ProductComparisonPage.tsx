        ...
        <main className="flex-grow max-w-7xl mx-auto px-4 md:px-8 w-full">
          ...
          {products.length === 0 ? (
            ...
            <>
              ...
              <div className="md:hidden glass-panel rounded-2xl overflow-hidden border border-white/10 flex min-w-0">
                {/* Sticky labels */}
                ...
                <div className="flex overflow-x-auto">
                  {products.map((product) => (
                    <div key={product.id} className="w-[min(78vw,240px)] flex-shrink-0 flex flex-col border-r border-white/10">
                      <div className="min-h-40 border-b border-white/10 p-3 flex flex-col items-center relative">
                        <button
                          onClick={() => removeProduct(product.id)}
                      ...
                      <div className="min-h-14 flex items-center justify-center px-2 py-3 border-b border-white/10 text-xs text-center break-words">{product.brand}</div>
                      <div className="min-h-14 flex items-center justify-center px-2 py-3 border-b border-white/10 bg-surface-container/30 text-xs font-bold">{product.condition}</div>
                      <div className="min-h-14 flex items-center justify-center px-2 py-3 border-b border-white/10 text-[10px] text-on-surface-variant text-center break-words">{product.specs}</div>
                      <div className="min-h-14 flex items-center justify-center px-2 py-3 border-b border-white/10 bg-surface-container/30 text-xs text-center break-words">{product.warranty}</div>
                      <div className={`min-h-14 flex items-center justify-center px-2 py-3 border-b border-white/10 text-xs font-bold ${product.availability === 'In Stock' ? 'text-primary' : 'text-error'
                        }`}>
                        {product.availability}
                      </div>
                      <div className="min-h-28 p-3 flex flex-col gap-2">
                        <button
                          onClick={() => handleBuyNow(product)}
